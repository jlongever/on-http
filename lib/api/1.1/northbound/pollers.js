 ...
 */
function pollerRouterFactory (waterline, rest, pollerService, Constants, Promise, _) {
    ...
    router.get('/pollers/:identifier/data', rest(function(req) {
        return pollerService.requestPollerCache(req.params.identifier);
    }));
    ...
    router.get('/pollers/:identifier/data/current', rest(function(req) {
        return pollerService.requestPollerCache(req.params.identifier, { latestOnly: true });
    }));
